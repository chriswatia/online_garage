    ...
    <div class="container-fluid px-4">
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ url('edit-booking/'.$booking->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" name="date" value="{{ $booking->date }}" class="form-control" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <textarea name="notes" id="" class="form-control" required>{{ $booking->notes }}</textarea>
                        </div>
                    </div>
                    <div class="row">
