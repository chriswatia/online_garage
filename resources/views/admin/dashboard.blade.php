                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Total Services Offered</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ count(App\Models\Service::all()) }}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Low Stock</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ count(App\Models\Product::where('quantity', '<=', 10)->get()) }}</div>
                        </div>
                        <div class="col-auto">
