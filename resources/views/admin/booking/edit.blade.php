    ...
    <div class="container-fluid px-4">
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ url('admin/assignMechanic/'.$booking->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="mechanic_id" required>
